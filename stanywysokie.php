...
<?php
        ...
        $datacznowyy = $_POST['datawyspocz'];
        $dataczknowyy = $_POST['datawyskon'];
        $sql6 = "SELECT * FROM czujniki2 WHERE data>='$datacznowyy' AND data<='$dataczknowyy' AND stan='1' AND nr_urzadzenia={$_SESSION['nr_urzadzenia']} ";
        if($rezultat3 = @$polaczenie->query($sql6))
        {
